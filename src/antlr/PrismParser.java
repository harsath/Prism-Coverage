...
public class PrismParser extends Parser {
	...
	public static final int
		...
		T__17=18, ID=19, INT=20, FUNCTION=21, CLASS=22, IF=23, ELSE=24, METHODS=25, 
		ATTRIBUTES=26, RETURN=27, COMMENT=28, WS=29, LCURLY=30, RCURLY=31, LPAREN=32, 
		RPAREN=33, SEMICOLON=34, MUL=35, DIV=36, ADD=37, SUB=38, MAX=39, MIN=40, 
		POW=41, PRINT=42, PRINTLN=43;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'FOR'", "'!'", "'=='", "'||'", "'&&'", "'>'", "'<'", "'>='", "'<='", 
			"'true'", "'false'", null, null, "'FUNCTION'", "'CLASS'", "'IF'", "'ELSE'", 
			"'METHODS'", "'ATTRIBUTES'", "'RETURN'", null, null, "'{'", "'}'", "'('", 
			"')'", "';'", "'*'", "'/'", "'+'", "'-'", "'MAX'", "'MIN'", "'POW'", 
			"'PRINT'", "'PRINTLN'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, "ID", "INT", "FUNCTION", "CLASS", 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 6291516L) != 0 );
			setState(53);
			match(EOF);
			}
		}
	...
	public final Stmt_blockContext stmt_block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 17322821419964L) != 0) {
				{
				{
				setState(108);
				stmt();
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 17321605071360L) != 0) {
					{
					setState(130);
					expr(0);
					}
